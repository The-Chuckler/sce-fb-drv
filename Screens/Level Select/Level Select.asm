...
;		move.b	#GameModeID_LevelScreen,(Game_mode).w						; set screen mode to Level
	    moveq #0,d0
    	move.b (LevelSelect_vertical_count+1).w,d0
        add.b d0,d0
...
LevelSelect_HeaderText:		levselstr "GAMEMODE SELECT - CUBE DEMO GAME LOL BY AUBREY                   "

; main text
LevelSelect_MainText:
		levselstr "   LEVEL SELECT       - ACT 1"
		levselstr "   LEVEL              - DUMMYST"
		levselstr "   CUBE TEST SCREEN   - RINGLOL"
